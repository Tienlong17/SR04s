...
def main():
    i = 1
    while (i):
        'Controll(servo0,servo1,servo2)'
        
        Controll_1(servo1,90)
        "(servo1,90)"
        "Controll_1(servo2,90) "
        "Controll_Forward(servo0,0,90)"
        "time.sleep(5)"
        
        "Controll_Forward(servo1,0,90)"
        "time.sleep(5)"
        'Controll_Forward(servo1,0,90)'
        time.sleep(5)
        Controll_Forward(servo0,0,90)
        Controll_Backward(servo0,90,0)
